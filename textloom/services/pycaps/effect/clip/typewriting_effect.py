...
from services.pycaps.common import Document, WordClip, ElementState
from services.pycaps.tag import TagCondition
...
class TypewritingEffect(ClipEffect):
    ...
    def _apply_typewriting(self, word_index: int, clip: WordClip) -> None:
        from services.pycaps.video.render import CompositeElement, ImageElement
        import numpy as np
