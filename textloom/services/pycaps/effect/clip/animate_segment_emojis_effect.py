...
from services.pycaps.common import Document, WordClip
from services.pycaps.tag import TagConditionFactory, BuiltinTag
...
class AnimateSegmentEmojisEffect(ClipEffect):
    ...
    def __animate_emoji_if_possible(self, clip: WordClip) -> None:
        from services.pycaps.video.render import PngSequenceElement
